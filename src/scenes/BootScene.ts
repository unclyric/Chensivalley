...
export class BootScene extends Phaser.Scene {
  ...
  private createNPCTextures(): void {
    ...
    const drawNPCs = [
      ...
      (g: Phaser.GameObjects.Graphics) => {
        g.fillStyle(0x000000, 0.1); g.fillEllipse(8 * sc, 15 * sc + 1, 8 * sc, 3);
        // Pure black coat (no color tint)
        g.fillStyle(0x0d0d0d); g.fillRect(4 * sc, 6 * sc, 8 * sc, 6 * sc);
        g.fillStyle(0x1a1a1a, 0.6); g.fillRect(5 * sc, 6 * sc, 6 * sc, 3 * sc);
        // Coat fold lines
        g.fillStyle(0x050505, 0.5); g.fillRect(6 * sc, 7 * sc, 0.8, 5 * sc);
        g.fillRect(9 * sc, 7 * sc, 0.8, 5 * sc);
        // Coat lapel highlight
        g.fillStyle(0x2a2a2a, 0.25); g.fillRect(5 * sc, 7 * sc, 1.5 * sc, 4 * sc);
        // Gold buttons
        ...
        // Black hair (neat, pure black)
        g.fillStyle(0x080808); g.fillRect(4 * sc, 0, 8 * sc, 3 * sc);
        g.fillStyle(0x151515, 0.35); g.fillRect(5 * sc, 1 * sc, 6 * sc, 1.5 * sc);
        // Warm eyes
        ...
        // Pure black boots
        g.fillStyle(0x0a0a0a); g.fillRect(5.5 * sc, 12 * sc, 3 * sc, 3 * sc);
